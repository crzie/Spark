...
const SignIn = () => {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-green-white ">
      <div
        className="w-3/4 h-3/4 bg-red-500 flex items-center justify-between rounded-2xl"
        style={{ backgroundColor: "#A1DEBB" }}
      >
        <div className="w-1/2 h-full flex items-center justify-center">
          <img className="w-100 h-1/2" src={logo} alt="" />
        </div>
        <form
          className="w-1/2 h-full bg-white flex flex-col justify-center"
          onSubmit={handleSubmit}
        >
          <p className="pb-5 w-full flex flex-col items-center text-5xl text-emerald-900 font-normal">
            Login
          </p>
